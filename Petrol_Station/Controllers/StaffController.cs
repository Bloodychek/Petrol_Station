...
namespace Petrol_Station.Controllers
{
    public class StaffController : Controller
    {
        ...
        private IQueryable<Staff> GetSortedEntities(SortState sortState, string fullName, int staffAge, string staffFunction, DateTime workingHoursForAweek, DateTime firstPoint, DateTime endPoint)
        {
